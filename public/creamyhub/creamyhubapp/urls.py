...
urlpatterns = [
    ...
    path('Delete_placeorderviewAPIView/<int:id>',views.Delete_placeorderviewAPIView.as_view(),name='Delete_placeorderviewAPIView'),
    path('placeAPIView',views.placeAPIView.as_view(),name='placeAPIView'),
    path('VieworderAPIView/<int:id>',views.VieworderAPIView.as_view(),name='VieworderAPIView'),
